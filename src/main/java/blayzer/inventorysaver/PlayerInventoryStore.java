...
import blayzer.inventorysaver.api.InventoryEvent;
import blayzer.inventorysaver.api.InventoryEvent.SubInventory;
import blayzer.inventorysaver.utils.Log;
import blayzer.inventorysaver.utils.GenericInventory;
import blayzer.inventorysaver.utils.ItemUtils;
import blayzer.inventorysaver.utils.TagUtils;
import org.apache.commons.lang3.StringUtils;

public class PlayerInventoryStore {
	
	public static final boolean dumpInventoryEnabled = true;
	...
	public void onPlayerDeath(LivingDeathEvent event) {
		if (dumpInventoryEnabled && (event.entity instanceof EntityPlayerMP) && !(event.entity instanceof FakePlayer)) {
